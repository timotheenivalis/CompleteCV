...
\begin{tabular}{p{4cm}|p{11cm}}
\hfill \textsc{2016} & Jury member for best talks/posters at YNHM 16, Paris\\
\multicolumn{2}{c}{} \\
\end{tabular}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\vspace{10pt}
\begin{itemize}
\item \textbf{Bonnet, T.}, Wandeler, P., Camenisch, G. \& Postma, E.. Adaptive evolution goes against phenotypic selection in a wild rodent population. \textit{Under review in Science}.
...
\item Hagmayer, A., \textbf{Bonnet, T.}, Camenisch, G., Canale, C.  \& Postma E.. Body mass-independent selection on resting metabolic rate in a wild population of snow voles (\textit{Chionomys nivalis}). \textit{In prep.}
\end{itemize}
\end{document}