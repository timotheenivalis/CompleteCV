...
ISI citations: 41 (+13 then did not find yet)
\vspace{10pt}
\begin{itemize}
...
\item van Benthem *, K., Bruijning, M. *, \textbf{Bonnet, T. *}, Jongejans, E., Postma, E. \& Ozgul, A.. Disentangling evolutionary, plastic and demographic processes underlying trait dynamics: A review of four frameworks. \textit{Methods in Ecology and Evolution} 8:75--85. (* co-first authors) 
...
\vspace{10pt}
\begin{itemize}
\item \textbf{Bonnet, T.} \& Postma, E.. Selection fluctuates but evolution does not in a wild rodent population. \textit{Submitted to Evolution}.
\item \textbf{Bonnet, T.}, Leblois, R., Rousset, F. \& Crochet, P.A.. A reassessment of explanations for discordant introgressions of mitochondrial and nuclear genomes. \textit{Submitted to Evolution}.
\end{itemize}
